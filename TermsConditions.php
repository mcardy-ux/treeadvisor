...
<section class="flat-case-details">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                    <h3 class="section-heading-jost-size46 fw-500 text-pri2-color center mg-bottom-35">Terms and Conditions</h3>
                    <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">Introduction</h3>
                        <p class="section-desc mg-bottom-35">Welcome to <a href="https://www.TreeAdvisor.org" style="color: #348e38 !important;"> https://www.TreeAdvisor.org </a> (the “Website”).
                            <br>
                            ...
                            <br>
                            These Terms and Conditions outline the rules and regulations for the use of <a href="https://www.TreeAdvisor.org" style="color: #348e38 !important;"> https://www.TreeAdvisor.org </a>
                            <br><br>
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">1 Definitions </h3>
                        <p class="section-desc mg-bottom-35">
                            The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice, and any or all agreements: 
                            <br><br>
                            “<strong>Company</strong>,” “<strong>Us</strong>,” “<strong>We</strong>,” and “<strong>Our</strong>” refers to TreeAdvisor Outdoor Living, LLC. 
                            <br>
                            “<strong>Content</strong>” is the information displayed at the Website including without limitation text, data, code, images, photographs, graphics, software, designs, and any other materials that are available at the Website. 
                            <br>
                            “<strong>Goods</strong>” means all goods that We supply and make available to You as detailed in the Invoice. 
                            <br>
                            “<strong>Invoice</strong>” is a list of the Goods sent or the Services We provide to You, detailing individual amounts of Goods or Services plus a sum total. 
                            <br>
                            “<strong>Party</strong>” refers to either You, or Us, or any other party to this Agreement. “<strong>Parties</strong>” refer to both You and Us. 
                            <br>
                            “<strong>Services</strong>” refer to any work We perform for You. 
                            <br>
                            “<strong>Supply</strong>” means to provide the Goods or Services as per the Invoice. 
                            <br>
                            “<strong>You</strong>” and “<strong>Your</strong>” refer to the visitor, user, client, customer, or person accessing the Website and thus accepting this Agreement. 
                        </p>
                              
                        
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">2 User Rights and Responsibility </h3>
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15"> 2.1 Acceptable use </h3>
                        <p class="section-desc mg-bottom-35">
                            • TreeAdvisor Outdoor Living, LLC. will not be held liable should the website be unavailable for any amount of time. 
                                <br>
                            • You are responsible for the safety and confidentiality of your passwords and usernames. TreeAdvisor Outdoor Living, LLC. has the right to terminate or suspend your username and password should we suspect non-compliance by you. 
                                <br>
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15"> 2.2 Prohibited Use </h3>
                        <p class="section-desc mg-bottom-35">
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">3 Our Content </h3>
                        <p class="section-desc mg-bottom-35">
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">6 Website Information</h3> 
                        <p class="section-desc mg-bottom-35">
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">7 Security </h3>
                        <p class="section-desc mg-bottom-35">
                            Information provided by you through  <a href="https://www.TreeAdvisor.org" style="color: #348e38 !important;"> https://www.TreeAdvisor.org </a> is stored on a secured private server. While we have taken reasonable precautions to protect your personal information, no security system is impenetrable and we cannot guarantee the security of information that you provide to us via the Internet, through our Website, through online ordering, or in databases stored on our servers. 
                            <br>
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">8 Links to this Website</h3> 
                        <p class="section-desc mg-bottom-35">
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">9 Third-Party Links</h3> 
                        <p class="section-desc mg-bottom-35">
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">10 Intellectual Property Rights </h3>
                        <p class="section-desc mg-bottom-35">
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">11 Copyright Notice </h3>
                        <p class="section-desc mg-bottom-35">
                            All Website design, graphics, text selections, arrangements, and all software are of Copyright © 2022, TreeAdvisor Outdoor Living, LLC. or its licensors. ALL RIGHTS RESERVED. 
                            </p>
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">12 Disclaimers </h3>
                        <p class="section-desc mg-bottom-35">
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">15 Release </h3>
                        <p class="section-desc mg-bottom-35">
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">16 Communication</h3> 
                        <p class="section-desc mg-bottom-35">
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">17 Dispute Resolution and Arbitration</h3> 
                        <p class="section-desc mg-bottom-35">
                            You and We agree to the following dispute resolution process for any legal controversy or legal claim arising out of or relating to this Agreement, the Website, any subscription to the Website or any other aspect of Our relationship (“<strong>Subject Legal Claim</strong>”). 
                            <br>
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">18 Termination </h3>
                        <p class="section-desc mg-bottom-35">
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">19 Consequences of Termination or Expiration </h3>
                        <p class="section-desc mg-bottom-35">
                            ...
                            <br>
                            • You will immediately cease use of and/or access to the Account, Website, and Services. 
                            <br>
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">20 Revisions </h3>
                        <p class="section-desc mg-bottom-35">
                    ...
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">21 Force Majeure </h3>
                        <p class="section-desc mg-bottom-35">
                            ...
                            or labor unrest, including without limitation, strikes, slowdowns, picketing, or boycotts; inability to secure raw materials, transportation facilities, fuel or energy shortages, or acts or omissions of other common carriers. 
                            </p>
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">22 Minimum Age Requirements </h3>
                        <p class="section-desc mg-bottom-35">
                            Our Website is not directed to children. Access to and use of Our Website is only for those who are at least at the age of <strong>13 years in the USA</strong> or otherwise capable of entering into and performing legal agreements. If You are younger than this, You may not register for or use Our Website. 
                            <br><br>
                            Any person who registers as a user or provides their personal information to Our Website represents that they are at least at the age of <strong>13 years in the USA</strong>  or otherwise capable of entering into and performing legal agreements. 
                            <br><br>
                            In agreeing with this Agreement, You represent and warrant that You are at least at the age of <strong>13 years in the USA</strong>  or otherwise capable of entering into and performing legal agreements. 
                             </p>
                    <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">23 General </h3>
                        <p class="section-desc mg-bottom-35">
                            <strong>Jurisdiction and Choice of Law.</strong> Any claim relating to, and the use of, this Website and the materials contained herein is governed by the laws of the USA.  
                            <br>
                            <strong> Entire Agreement.</strong> This Agreement and the other agreements stipulated to be incorporated herein are the entire agreement between You and Us and supersede any prior understandings or agreements (written or oral). 
                            ...
                            <br>
                            <strong>Severability.</strong> If any provision of this Agreement is held to be invalid or unenforceable, such provision shall be struck and the remaining provisions shall be enforced. 
                            <br>
                            <strong>Assignment.</strong> You agree that this Agreement and all incorporated agreements may be automatically assigned by Us in Our sole discretion. You cannot assign this Agreement without Our written consent. 
                            <br>
                            <strong>Headings.</strong> Headings are for reference purposes only and in no way define, limit, construe or describe the scope or extent of such section. 
                            <br>
                            <strong>No Waiver.</strong> Our failure to act with respect to Your or others’ breach does not waive Our right to act with respect to subsequent or similar breaches. 
                            <br>
                            <strong>Survival.</strong> Clauses “Trademarks/No Endorsement”, “Advertising Rights”, “Intellectual Property Rights”, “DISCLAIMERS”, “LIMITATIONS OF LIABILITY”, “Indemnity”, “Release”, “Communications”, and “Dispute Resolution and Arbitration” shall survive any termination or expiration of this Agreement.   
                            </p>
