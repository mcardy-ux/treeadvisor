...
<section class="flat-case-details">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="section-heading-jost-size46 fw-500 text-pri2-color center mg-bottom-35 ">Privacy Policy</h3>
                        <p class="section-desc mg-bottom-35" >We are committed to protecting Your privacy. This Privacy Policy describes how We collect, use, store, share and protect the information collected through <a href="https://www.TreeAdvisor.org" style="color: #348e38 !important;"> https://www.TreeAdvisor.org </a> (the “<strong>Website</strong>”). 
                            In this Privacy Policy, “We”, “Us”, and “Our” refer to TreeAdvisor Outdoor Living, LLC. For more information about Us, see “Our Details” at the end of this Policy. 
                        <br><br>
                            This Privacy Policy is incorporated into and subject to Our <strong>Terms and Conditions</strong>. Capitalized words used but not defined in this Privacy Policy have the meaning given to them in the Terms and Conditions.
                        <br><br>
                ...
                <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15" >2.1. Data We Collect</h3>
                        <p class="section-desc mg-bottom-35">
                ...
                <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">2.2 How We Collect Data</h3>
                        <p class="section-desc mg-bottom-35">
                            ...
                            • Participating in communities, chat rooms and comment threads, other fora, and other interactive services in the Website; 
                                <br>
                            • Submission of User Content on any part of the Website that permits it; 
                                <br>
                ...
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">3 Personal Data On Or From Social Media </h3>
                        <p class="section-desc mg-bottom-35">
                ...
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">4 Use of Personal Data </h3> 
                        <p class="section-desc mg-bottom-35">
                            We do NOT sell or license Your Personal Data to any third party. <br>
                            ...
                            Specifically, We use Your Personal Data for the following:
                                ...
                                • providing Goods and Services to You; 
                                    <br>
                                • providing tips, news and/or updates; </p>
                        <p>
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">5 Sharing Of Personal Data </h3> 
                        <p class="section-desc mg-bottom-35">
                        We may share your Personal Data with the following:
                        <br>
                       <strong>Third-Party Suppliers.</strong> We may disclose Your<strong> Enquiry Data </strong>to one or more of those selected third-party suppliers of Goods and Services identified on Our Website for the purpose of enabling them to contact You so that they can offer, market and sell relevant Goods and/or Services to You. Each such third party will act as a data controller in relation to the Enquiry Data that We supply to it; and upon contacting You, each such third party will supply to You a copy of its own privacy policy, which will govern that third party’s use of Your Personal Data. The suppliers and providers with whom We may share Your information include:
                        <br><br>
                ...
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">6 Retaining and Deleting Personal Data </h3> 
                        ...
                        <br>        
                        We will retain Your Personal Data for a maximum period of 36 months. 
                        <br>
                ...
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">7 Data Security </h3> 
                        <p class="section-desc mg-bottom-35">
                        We follow generally accepted industry standards to protect the information submitted to Us, both during transmission and once We receive it. We maintain appropriate administrative, technical and physical safeguards to protect Personal Data against accidental or unlawful destruction, accidental loss, unauthorized alteration, unauthorized disclosure or access, misuse, and any other unlawful form of processing of the Personal Data in Our possession. This includes, for example, firewalls, password protection and other access and authentication controls.
                        <br>
                        We use HTTPS 
                        <br><br>
                        HTTPS (Hypertext Transfer Protocol Secure) is an internet communication protocol that protects the integrity and confidentiality of data between your computer and <a href="https://www.TreeAdvisor.org" style="color: #348e38 !important;"> https://www.TreeAdvisor.org </a> The use of HTTPS makes sure your communication with us is:
                        <br><br> 
                        <strong>Encrypted</strong> — The data you exchange with us is secure from eavesdroppers. That means that when you are browsing www.TreeAdvisor.org, nobody can track your activities across multiple pages, or steal the data exchange between your computer and <a href="https://www.TreeAdvisor.org" style="color: #348e38 !important;"> https://www.TreeAdvisor.org </a>
                        <br><br> 
                        <strong>Integral</strong> — The use of HTTPS preserves the integrity of data. Your data cannot be modified or corrupted during transfer.
                        <br><br>
                ...
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">8 Non-Personal Data </h3>
                        <p class="section-desc mg-bottom-35">
                ...
                <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">8.1 Generally, We collect and store the following Non-Personal Data: </h3>
                        <p class="section-desc mg-bottom-35">
                ...
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">9 Use of Non-Personal Data </h3>
                       <p class="section-desc mg-bottom-35">
                       ...
                       <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">10 Personal & Non-Personal Data From Other Sources</h3> 
                       <p class="section-desc mg-bottom-35">
                ...
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">11 Your Choices</h3> 
                    <p class="section-desc mg-bottom-35">
                        ...
                        <br>
                        Even after Your account is canceled, We may retain Your information for the purposes set forth in this Privacy Policy. 
                       </p>
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">12 Your Right to Access</h3> 
                        <p class="section-desc mg-bottom-35">
                        We provide You with reasonable access to the Personal Data that You may provide through the Website. 
                       </p>

                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">13 Your Right to Withdraw Consent</h3> 
                        <p class="section-desc mg-bottom-35">
                ...
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">14 Your Right to Update, Correct or Delete </h3>
                        <p class="section-desc mg-bottom-35">
                ...
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">15 California Privacy Rights</h3> 
                        <p class="section-desc mg-bottom-35">    
                        ...
                        <br>
                        <strong>California Do Not Track Disclosure:</strong> We do not track the personally identifying information of Our users and visitors over time and across third-party websites to provide targeted advertising. We respond to Do Not Track (DNT) signals. However, some other third-party websites do keep track of Your browsing activities so that they can tailor the information or advertising they present to You. If You wish to opt-out of this tracking, You can enable privacy settings in Your browser. 
                        <br>
                       </p>
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">16 No Personal Data From Children</h3>
                        <p class="section-desc mg-bottom-35">
                        We do not knowingly collect Personal Data from children under 13 years of age in the USA. The Website is not directed to children under the age of 13 in the USA. We will not knowingly allow children under 13 in the USA to register for or become users of the Website. 
                        <br>
                        If You are under 13 years of age in the USA, You should not provide Personal Data to Us. 
                        <br>
                        If We discover that a child under the age of 13 in the USA has provided Us with Personal Data and We do not have parental consent, We will immediately delete that child’s information. 
                       </p>
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">17 Cookie Policy</h3>
                        <p class="section-desc mg-bottom-35">
                ...
                <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">17.1 Cookie We Use</h3>
                    <p class="section-desc mg-bottom-35">
                        <strong>Session Cookies</strong> 
                        <br>
                        These are temporary cookies that contain no expiration date and are deleted after the user’s browser is closed. You will be required to log in again at the next session, where you will be treated as a new user 
                        <br>
                        Session cookies examples: Shopping cart, remembering previous actions, managing and passing security tokens, multimedia content player session cookies, load balancing session cookies and third-party social content plugin sharing cookies 
                        <br><br>
                        <strong>Persistent Cookies</strong> 
                        <br>
                        These are cookies that are saved in your browser until they are deleted by you or are deleted by your browser after they reach their expiration date. 
                        <br>
                        ...
                        <br>
                        Performance cookies allow us to collect information, such as the most used pages or error messages, in order to understand how you use our website and enable us to create a better user experience. All information collected by performance cookies is anonymous. 
                    </p>

                <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">17.2 Purpose Of Using Cookies</h3> 
                    <p class="section-desc mg-bottom-35">
                        ...
                        <br>
                        <strong>Security</strong> – We use cookies as an element of the security measures used to protect user accounts, including preventing fraudulent use of login credentials, and to protect Our Website and Services generally; 
                        <br>
                        <strong>Analysis</strong> – We use cookies to help Us to analyze the use and performance of Our Website and Services; 
                        <br>
                        <strong>Cookie Consent</strong> – We use cookies to store Your preferences in relation to the use of cookies more generally. 
                    </p>
                <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">17.3 Cookies Used by Our Service Providers </h3>
                    <p class="section-desc mg-bottom-35">
                        Our service providers use cookies and those cookies may be stored on Your computer when You visit Our Website. 
                        <br>
                        Google Analytics. We use Google Analytics to analyze the use of Our Website. Google Analytics gathers information about Website use by means of cookies. The information gathered relating to Our Website is used to create reports about the use of Our Website. Google’s privacy policy is available at: <a href="https://www.google.com/policies/privacy/." style="color: #348e38 !important;">https://www.google.com/policies/privacy/</a>
                    </p>
                <h3 class="section-heading-jost-size22 fw-500 text-pri2-color mg-bottom-15">17.4 Managing Cookies</h3>
                    <p class="section-desc mg-bottom-35">
                        ...
                        Opt Out Page 
                        <br>
                        <a href="https://tools.google.com/dlpage/gaoptout"style="color: #348e38 !important;">Opt Out</a>
                        <br><br>
                        Privacy Policy 
                        <br>
                        <a href="https://policies.google.com/privacy"style="color: #348e38 !important;">Privacy Policy</a>
                    </p>
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">18 Links To Or From Another Website</h3>
                    <p class="section-desc mg-bottom-35">   
                ...
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">19 Public Areas</h3>
                    <p class="section-desc mg-bottom-35">
                ...
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">20 Interest-Based Advertising</h3>
                    <p class="section-desc mg-bottom-35">
                        ...
                        <br>
                        <strong>Opt-Out</strong>. You can opt-out of receiving interest-based advertising on Your computer or laptop from some companies, including Us and Our service providers. 
                        <br>    
                ...
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">21 Changes And Updates </h3>
                    <p class="section-desc mg-bottom-35">
                ...
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">22 Assignment</h3>
                    <p class="section-desc mg-bottom-35">
                ...
                <h3 class="section-heading-jost-size34 fw-500 text-pri2-color mg-bottom-15">23 Our Details<h3>
                    <p class="section-desc mg-bottom-35">
